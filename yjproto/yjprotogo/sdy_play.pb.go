...
type SdyBcScorePai struct {
	...
	IsChengPai       *bool        `protobuf:"varint,7,opt,name=isChengPai" json:"isChengPai,omitempty"`
	IsGuangPai       *bool        `protobuf:"varint,8,opt,name=isGuangPai" json:"isGuangPai,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (m *SdyBcScorePai) GetIsWangKou() bool {
...
func (m *SdyBcScorePai) GetIsChengPai() bool {
...
func (m *SdyBcScorePai) GetIsGuangPai() bool {
	if m != nil && m.IsGuangPai != nil {
		return *m.IsGuangPai
	}
	return false
}
...
var fileDescriptor7 = []byte{
	...
	,
}

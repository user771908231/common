...
func (TdkEnumProtoId) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (TdkEnumDeskstatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func (TdkEnumRadyrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{2} }
...
func (TdkEnumDisdesicionrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{3} }
...
func (TdkEnumUserdisdesicion) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{4} }
...
func (TdkEnumDeskstartrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{5} }
...
func (TdkEnumBetrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{6} }
...
func (TdkEnumQijiaorsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{7} }
...
func (TdkEnumFantirsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{8} }
...
func (TdkEnumFoldrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{9} }
...
func (TdkEnumDeskendtype) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{10} }
...
func (TdkEnumReqdisdeskrsp) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{11} }

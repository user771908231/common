...
func (PezEnumProtoId) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{0} }
...
func (PezEnum_PEZTYPE) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{1} }
...
func (PezEnum_ErrorCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{2} }
...
func (PezEnum_Option) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{3} }
...
func (Pez_RoomType) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{4} }
...
func (PezEnumMjColor) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{5} }
...
func (PezEnum_PaiType) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{6} }
...
func (PezEnum_Base) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{7} }
...
func (PezEnum_Bet) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{8} }
...
func (PezEnum_UserGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{9} }
...
func (PezEnum_DeskGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{10} }
...
func (PezEnum_TuoziType) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{11} }
...
func (*PezBase_PaiInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{0} }
...
func (*PezBase_PlayConf) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{1} }
...
func (*PezBase_RoomTypeInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{2} }
...
func (*PezBaseTimerInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{3} }
...
func (*PezBase_PaiValue) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{4} }
...
func (*PezBase_PlayerCard) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{5} }
...
func (*PezLastScore) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{6} }
...
func (*PezBase_PlayerInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{7} }
...
func (*PezBase_DeskGameInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{8} }
...
func (*PezTuozi) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{9} }

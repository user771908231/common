...
func (PezEnum_UserGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor35, []int{6} }
...
func (PezEnum_DeskGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor35, []int{7} }
...
func (*PezBase_PlayOptions) Descriptor() ([]byte, []int) { return fileDescriptor35, []int{1} }
...
func (*PezBase_PlayConf) Descriptor() ([]byte, []int) { return fileDescriptor35, []int{2} }
...
func (*PezBase_RoomTypeInfo) Descriptor() ([]byte, []int) { return fileDescriptor35, []int{3} }
...
func (*PezBase_PaiValue) Descriptor() ([]byte, []int) { return fileDescriptor35, []int{4} }
...
func (*PezBase_PlayerCard) Descriptor() ([]byte, []int) { return fileDescriptor35, []int{5} }
...
var fileDescriptor35 = []byte{
	...
	,
}

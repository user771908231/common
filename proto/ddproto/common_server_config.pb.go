...
func (*TConfigSys) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*TConfigDrawLottery) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func init() { proto.RegisterFile("common_server_config.proto", fileDescriptor9) }

...
func (EProtoId) EnumDescriptor() ([]byte, []int) { return fileDescriptor26, []int{0} }
...
func (ZjhEnumPlayerGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor26, []int{1} }
...
func (ZjhEnumDeskState) EnumDescriptor() ([]byte, []int) { return fileDescriptor26, []int{2} }
...
func (ZjhEnumUserState) EnumDescriptor() ([]byte, []int) { return fileDescriptor26, []int{3} }
...
func (ZjhEnumRoomType) EnumDescriptor() ([]byte, []int) { return fileDescriptor26, []int{4} }
...
func init() { proto.RegisterFile("zjh_base.proto", fileDescriptor26) }

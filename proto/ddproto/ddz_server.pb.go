...
func (*DdzSrvOutPokerPais) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func (*DdzSrvDeskTongJi) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{1} }
...
func (*DdzSrvDesk) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{2} }
...
func (*DdzSrvGameData) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{3} }
...
func (*DdzSrvBillBean) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{4} }
...
func (*DdzSrvBill) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{5} }
...
func (*DdzSrvUserStatisticsRound) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{6} }
...
func (*DdzSrvUserStatistics) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{7} }
...
func (*DdzSrvUser) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{8} }
...
func (*DdzSrvRoom) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{9} }
...
func (*DdzSrvBak) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{10} }

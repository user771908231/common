...
func (*GameSession) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*CommonSrvGameUser) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*CommonSrvGameDesk) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func init() { proto.RegisterFile("common_server.proto", fileDescriptor10) }

...
func (*PdkReqDissolveDesk) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{0} }
...
func (*PdkAckDissolveDesk) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{1} }
...
func (*PdkReqReady) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{2} }
...
func (*PdkAckReady) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{3} }
...
func (*PdkBaseWinCoinInfo) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{4} }
...
func (*PdkBaCurrentResult) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{5} }
...
func (*PdkBaseEndLotteryInfo) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{6} }
...
func (*PdkBcEndLottery) Descriptor() ([]byte, []int) { return fileDescriptor32, []int{7} }
...
func init() { proto.RegisterFile("pdk_desk.proto", fileDescriptor32) }

...
func (HallEnumProtoId) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{0} }
...
func (HallEnumTradeType) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{1} }
...
func (HallEnumEvent) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{2} }
...
func (HallEnum_Reward) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{3} }
...
func (HallEnumMailType) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{4} }
...
func (HallLotteryItemType) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{5} }
...
func (HallEnumTaskType) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{6} }
...
func (HallUser_VIP) EnumDescriptor() ([]byte, []int) { return fileDescriptor25, []int{7} }
...
func (*HallItemEvent) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{0} }
...
func (*HallMailItem) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{1} }
...
func (*HallBagItem) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{2} }
...
func (*HallItemTask) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{3} }
...
func (*HallUserData) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{4} }
...
func (*HallRankItem) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{5} }
...
func (*CoinZone) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{6} }
...
func (*DiamondZone) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{7} }
...
func (*ExchangeZone) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{8} }
...
func (*BuyZone) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{9} }
...
func (*GoodsItem) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{10} }
...
func (*HallStrongboxInfo) Descriptor() ([]byte, []int) { return fileDescriptor25, []int{11} }

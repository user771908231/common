...
type HallUserData struct {
	...
	UserMoney         *int64  `protobuf:"varint,7,opt,name=userMoney" json:"userMoney,omitempty"`
	UserDiamond       *int64  `protobuf:"varint,8,opt,name=userDiamond" json:"userDiamond,omitempty"`
	UserRedBag        *string `protobuf:"bytes,9,opt,name=userRedBag" json:"userRedBag,omitempty"`
	UserLotteryTicket *int64  `protobuf:"varint,10,opt,name=userLotteryTicket" json:"userLotteryTicket,omitempty"`
	XXX_unrecognized  []byte  `json:"-"`
}
...
var fileDescriptor14 = []byte{
	...
	,
}

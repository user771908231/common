...
func (ErrorCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (MjEnumColor) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (MjEnumGangType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (MjEnumHuType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (MjEnumComposeCardType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func (MjEnumPaiType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{5} }
...
func (MjEnumUserGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{6} }
...
func (MjEnumDeskGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{7} }
...
func (MJRoomType) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{8} }
...
func (*CardInfo) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*ComposeCard) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*PlayerCard) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }

...
func (ZjhEnum_ZJHTYPE) EnumDescriptor() ([]byte, []int) { return fileDescriptor52, []int{0} }
...
func (ZjhEnumUserStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor52, []int{1} }
...
func (*ZjhSrvPoker) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{0} }
...
func (*ZjhSrvBill) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{1} }
...
func (*ZjhSrv_GameData) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{2} }
...
func (*ZjhSrvUser) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{3} }
...
func (*ZjhSrvDesk) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{4} }
...
func (*ZjhSrvRoom) Descriptor() ([]byte, []int) { return fileDescriptor52, []int{5} }
...
func init() { proto.RegisterFile("zjh_serever.proto", fileDescriptor52) }

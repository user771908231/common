...
func (PayEnumTradeStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (PayReturn) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*PayBaseProduct) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*PayBasePaymodel) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*PayBaseDetails) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*WxpayReqUnifiedorder) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*WxpayAckUnifiedorder) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*WxpayReqSyncChecker) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*WxpayAckSyncChecker) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
func (*ApplepayReqRechargecb) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*ApplepayAcksRechargecb) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }

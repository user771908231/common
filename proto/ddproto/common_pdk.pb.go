...
func (PdkEnumPaiType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (PdkEnumPlayerStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (PdkEnumRoomType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (PdkEnumEnterType) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func (PdkEnumCoinRoomLevel) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{4} }
...
func (PdkEnumDeskGameStatus) EnumDescriptor() ([]byte, []int) { return fileDescriptor7, []int{5} }
...
func (*PdkBaseRoomTypeInfo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*PdkBaseTimerInfo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }

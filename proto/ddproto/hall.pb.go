...
// 邮件REQ
type HallMailReq struct {
	Header           *ProtoHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}

func (m *HallMailReq) Reset()                    { *m = HallMailReq{} }
func (m *HallMailReq) String() string            { return proto.CompactTextString(m) }
func (*HallMailReq) ProtoMessage()               {}
func (*HallMailReq) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }

func (m *HallMailReq) GetHeader() *ProtoHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
// 邮件ACK
type HallMailAck struct {
	Header           *ProtoHeader    `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	List             []*HallMailItem `protobuf:"bytes,2,rep,name=list" json:"list,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}

func (m *HallMailAck) Reset()                    { *m = HallMailAck{} }
func (m *HallMailAck) String() string            { return proto.CompactTextString(m) }
func (*HallMailAck) ProtoMessage()               {}
func (*HallMailAck) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }

func (m *HallMailAck) GetHeader() *ProtoHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *HallMailAck) GetList() []*HallMailItem {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HallMailReq)(nil), "ddproto.hall_mail_req")
	proto.RegisterType((*HallMailAck)(nil), "ddproto.hall_mail_ack")
...
var fileDescriptor13 = []byte{
	...
	,
}

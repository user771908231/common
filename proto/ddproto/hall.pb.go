...
// 邮件REQ
type HallMailListReq struct {
	Header           *ProtoHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}

func (m *HallMailListReq) Reset()                    { *m = HallMailListReq{} }
func (m *HallMailListReq) String() string            { return proto.CompactTextString(m) }
func (*HallMailListReq) ProtoMessage()               {}
func (*HallMailListReq) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{2} }

func (m *HallMailListReq) GetHeader() *ProtoHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
// 邮件ACK
type HallMailListAck struct {
	Header           *ProtoHeader    `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	List             []*HallMailItem `protobuf:"bytes,2,rep,name=list" json:"list,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}

func (m *HallMailListAck) Reset()                    { *m = HallMailListAck{} }
func (m *HallMailListAck) String() string            { return proto.CompactTextString(m) }
func (*HallMailListAck) ProtoMessage()               {}
func (*HallMailListAck) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{3} }

func (m *HallMailListAck) GetHeader() *ProtoHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *HallMailListAck) GetList() []*HallMailItem {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*HallMailListReq)(nil), "ddproto.hall_mail_list_req")
	proto.RegisterType((*HallMailListAck)(nil), "ddproto.hall_mail_list_ack")
...
var fileDescriptor13 = []byte{
	...
	,
}

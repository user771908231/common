...
func (PEZ_RECONNECT_TYPE) EnumDescriptor() ([]byte, []int) { return fileDescriptor40, []int{0} }
...
func (*PezUserCoinBean) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{0} }
...
func (*Pez_Opening) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{1} }
...
func (*Pez_DealCards) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{2} }
...
func (*Pez_Bet) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{3} }
...
func (*Pez_AckBet) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{4} }
...
func (*Pez_BCOpenPai) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{5} }
...
func (*Pez_SendGameInfo) Descriptor() ([]byte, []int) { return fileDescriptor40, []int{6} }
...
var fileDescriptor40 = []byte{
	...
	,
}

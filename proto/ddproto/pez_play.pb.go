...
// Ignoring public import of BetInfo from pez_desk.proto

// Ignoring public import of pez_WinScoreInfo from pez_desk.proto
...
type Pez_DealCards struct {
	...
	ScoreInfo        []*Pez_WinScoreInfo   `protobuf:"bytes,5,rep,name=ScoreInfo" json:"ScoreInfo,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
func (m *Pez_DealCards) GetScoreInfo() []*Pez_WinScoreInfo {
	if m != nil {
		return m.ScoreInfo
	}
	return nil
...
type Pez_BCOpenPai struct {
	ScoreInfo        []*Pez_WinScoreInfo `protobuf:"bytes,1,rep,name=ScoreInfo" json:"ScoreInfo,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
...
func (*Pez_BCOpenPai) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{5} }

func (m *Pez_BCOpenPai) GetScoreInfo() []*Pez_WinScoreInfo {
	if m != nil {
		return m.ScoreInfo
	}
	return nil
...
func (*Pez_OpenCard) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{6} }
...
func (*Pez_AckOpenCard) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{7} }
...
func (*Pez_ActCompare) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{8} }
...
func (*Pez_AckActCompare) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{9} }
...
func (*Pez_SendGameInfo) Descriptor() ([]byte, []int) { return fileDescriptor37, []int{10} }
...
var fileDescriptor37 = []byte{
	...
	,
}

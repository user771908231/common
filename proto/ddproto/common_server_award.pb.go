...
func (Award) EnumDescriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*Taward) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{0} }
...
func (*AwardMOnline) Descriptor() ([]byte, []int) { return fileDescriptor11, []int{1} }
...
func init() { proto.RegisterFile("common_server_award.proto", fileDescriptor11) }

...
func (c *zzHzClient) CreateRoom(ctx context.Context, in *Game_CreateRoom, opts ...grpc.CallOption) (*Game_AckCreateRoom, error) {
	out := new(Game_AckCreateRoom)
	err := grpc.Invoke(ctx, "/mjproto.ZzHz/CreateRoom", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ZzHz_CreateRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mjproto.ZzHz/CreateRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZzHzServer).CreateRoom(ctx, req.(*Game_CreateRoom))
	}
	return interceptor(ctx, in, info, handler)
}

var _ZzHz_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mjproto.ZzHz",
...
func init() { proto.RegisterFile("rpc_zzhz.proto", fileDescriptor4) }

var fileDescriptor4 = []byte{
	// 109 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0x2b, 0x2a, 0x48, 0x8e,
	0xaf, 0xaa, 0xca, 0xa8, 0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xcf, 0xcd, 0x02, 0x33,
	0xa4, 0x84, 0x72, 0x13, 0x33, 0xb2, 0xf2, 0xf3, 0xd2, 0xe3, 0x33, 0x12, 0x73, 0x72, 0x20, 0x92,
	0x46, 0xbe, 0x5c, 0x2c, 0x51, 0x55, 0x1e, 0x55, 0x42, 0xae, 0x5c, 0x5c, 0xce, 0x45, 0xa9, 0x89,
	0x25, 0xa9, 0x41, 0xf9, 0xf9, 0xb9, 0x42, 0x12, 0x7a, 0x50, 0x3d, 0x7a, 0xe9, 0x89, 0xb9, 0xa9,
	0xf1, 0x08, 0x19, 0x29, 0x69, 0x54, 0x19, 0xc7, 0xe4, 0x6c, 0x84, 0xa4, 0x12, 0x43, 0x00, 0x03,
	0x20, 0x00, 0x00, 0xff, 0xff, 0x32, 0x06, 0x30, 0x09, 0x7e, 0x00, 0x00, 0x00,
}

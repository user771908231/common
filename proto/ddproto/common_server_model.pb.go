...
func (*TNotice) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*TGameCounts) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func (*TUserTask) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{3} }
...
func (*Push) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{4} }
...
var fileDescriptor10 = []byte{
	...
	,
}

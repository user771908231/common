...
func (*HelloRequest) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{0} }
...
func (*HelloReply) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{1} }
...
func init() { proto.RegisterFile("rpc_greeter.proto", fileDescriptor46) }

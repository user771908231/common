...
func (*ZjhReqGetRoomList) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{0} }
...
func (*ZjhBaseRoomInfo) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{1} }
...
func (*ZjhAckRoomList) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{2} }
...
func (*ZjhReqEnterDesk) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{3} }
...
func (m *ZjhReqEnterDesk) GetPassword() string {
...
func (*ZjhBaseUserInfo) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{4} }
...
func (*ZjhDeskStateAck) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{5} }
...
// =================================VIP-创建房间=============================
type ZjhReqCreateDesk struct {
	UserId           *uint32 `protobuf:"varint,1,opt,name=userId" json:"userId,omitempty"`
	BaseChip         *int64  `protobuf:"varint,2,opt,name=baseChip" json:"baseChip,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (*ZjhReqCreateDesk) Descriptor() ([]byte, []int) { return fileDescriptor54, []int{6} }
...
func (m *ZjhReqCreateDesk) GetBaseChip() int64 {
...
func init() { proto.RegisterFile("zjh_desk.proto", fileDescriptor54) }
...
var fileDescriptor54 = []byte{
	...
	,
}

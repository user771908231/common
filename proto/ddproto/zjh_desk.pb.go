...
func (*ZjhReqGetRoomList) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{0} }
...
func (*ZjhBaseRoomInfo) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{1} }
...
func (*ZjhAckRoomList) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{2} }
...
func (*ZjhReqEnterDesk) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{3} }
...
func (*ZjhBaseUserInfo) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{4} }
...
func (*ZjhDeskStateAck) Descriptor() ([]byte, []int) { return fileDescriptor49, []int{5} }
...
func init() { proto.RegisterFile("zjh_desk.proto", fileDescriptor49) }

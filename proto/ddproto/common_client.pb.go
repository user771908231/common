...
func (*CommonReqApplyDissolve) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
type CommonBcApplyDissolve struct {
	// 申请解散房间，只有朋友桌才有
	Header           *ProtoHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	UserId           []uint32     `protobuf:"varint,2,rep,name=userId" json:"userId,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (*CommonBcApplyDissolve) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*CommonReqApplyDissolveBack) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (*CommonAckApplyDissolveBack) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{31} }
...
var fileDescriptor0 = []byte{
	...
	,
}

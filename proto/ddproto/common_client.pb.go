...
It has these top-level messages:
	...
	CommonAckGameLogin
	CommonLotteryItem
	CommonSignLotteryInfo
	CommonDrawLotteryInfo
	CommonReqLogout
	CommonAckLogout
	CommonReqFeedback
	ClientBasePoker
...
type CommonAckGameLogin struct {
	...
	DrawLotteryInfo  *CommonDrawLotteryInfo `protobuf:"bytes,12,opt,name=drawLotteryInfo" json:"drawLotteryInfo,omitempty"`
	SignLotteryInfo  *CommonSignLotteryInfo `protobuf:"bytes,13,opt,name=signLotteryInfo" json:"signLotteryInfo,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
func (m *CommonAckGameLogin) GetDrawLotteryInfo() *CommonDrawLotteryInfo {
	if m != nil {
...
func (m *CommonAckGameLogin) GetSignLotteryInfo() *CommonSignLotteryInfo {
	if m != nil {
...
// 奖励物品信息
type CommonLotteryItem struct {
	Id               *int32  `protobuf:"varint,1,opt,name=id" json:"id,omitempty"`
	Name             *string `protobuf:"bytes,2,opt,name=name" json:"name,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *CommonLotteryItem) Reset()                    { *m = CommonLotteryItem{} }
func (m *CommonLotteryItem) String() string            { return proto.CompactTextString(m) }
func (*CommonLotteryItem) ProtoMessage()               {}
func (*CommonLotteryItem) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

func (m *CommonLotteryItem) GetId() int32 {
	if m != nil && m.Id != nil {
		return *m.Id
	}
	return 0
...
func (m *CommonLotteryItem) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
// 签到信息与奖励物品列表
type CommonSignLotteryInfo struct {
	...
	SignItems        []*CommonLotteryItem `protobuf:"bytes,4,rep,name=signItems" json:"signItems,omitempty"`
	XXX_unrecognized []byte               `json:"-"`
}

func (m *CommonSignLotteryInfo) Reset()                    { *m = CommonSignLotteryInfo{} }
func (m *CommonSignLotteryInfo) String() string            { return proto.CompactTextString(m) }
func (*CommonSignLotteryInfo) ProtoMessage()               {}
func (*CommonSignLotteryInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }

func (m *CommonSignLotteryInfo) GetIsSignToday() bool {
...
func (m *CommonSignLotteryInfo) GetTotalDays() int32 {
...
func (m *CommonSignLotteryInfo) GetContinuousDays() int32 {
...
func (m *CommonSignLotteryInfo) GetSignItems() []*CommonLotteryItem {
	if m != nil {
		return m.SignItems
	}
	return nil
...
// 转盘信息与奖励物品列表
type CommonDrawLotteryInfo struct {
	IsDrawToday      *bool                `protobuf:"varint,1,opt,name=isDrawToday" json:"isDrawToday,omitempty"`
	DialItems        []*CommonLotteryItem `protobuf:"bytes,2,rep,name=dialItems" json:"dialItems,omitempty"`
	XXX_unrecognized []byte               `json:"-"`
}

func (m *CommonDrawLotteryInfo) Reset()                    { *m = CommonDrawLotteryInfo{} }
func (m *CommonDrawLotteryInfo) String() string            { return proto.CompactTextString(m) }
func (*CommonDrawLotteryInfo) ProtoMessage()               {}
func (*CommonDrawLotteryInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }

func (m *CommonDrawLotteryInfo) GetIsDrawToday() bool {
...
func (m *CommonDrawLotteryInfo) GetDialItems() []*CommonLotteryItem {
	if m != nil {
		return m.DialItems
	}
	return nil
...
func (*CommonReqLogout) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }
...
func (*CommonAckLogout) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }
...
func (*CommonReqFeedback) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }
...
func (*ClientBasePoker) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }
...
func (*CommonReqMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }
...
func (*CommonBcMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (*CommonReqNotice) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*CommonAckNotice) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func init() {
	...
	proto.RegisterType((*CommonLotteryItem)(nil), "ddproto.common_lottery_item")
	proto.RegisterType((*CommonSignLotteryInfo)(nil), "ddproto.common_sign_lottery_info")
	proto.RegisterType((*CommonDrawLotteryInfo)(nil), "ddproto.common_draw_lottery_info")

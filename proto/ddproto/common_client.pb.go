...
type CommonAckGameLogin struct {
	...
	IsSignToday      *bool        `protobuf:"varint,12,opt,name=isSignToday" json:"isSignToday,omitempty"`
	XXX_unrecognized []byte       `json:"-"`
}
...
func (m *CommonAckGameLogin) GetIsSignToday() bool {
...
var fileDescriptor0 = []byte{
	...
	,
}

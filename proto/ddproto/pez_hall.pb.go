...
func (*PezReq_CreateRoom) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{0} }
...
func (*PezReq_AckCreateRoom) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{1} }
...
func (*PezReq_EnterRoom) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{2} }
...
func (*PezReq_AckEnterRoom) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{3} }
...
func (*Pez_Notice) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{4} }
...
func (*Pez_AckNotice) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{5} }
...
func (*Pez_GameRecord) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{6} }
...
func (*PezBeanUserRecord) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{7} }
...
func (*PezBeanGameRecord) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{8} }
...
func (*Pez_AckGameRecord) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{9} }
...
func (*Pez_Feedback) Descriptor() ([]byte, []int) { return fileDescriptor46, []int{10} }
...
func init() { proto.RegisterFile("pez_hall.proto", fileDescriptor46) }

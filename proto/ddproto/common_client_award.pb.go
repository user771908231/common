...
func (*AwardReqOnline) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*WardAckOnline) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (*AwardReqOnlineInfo) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*AwardAckOnlineInfo) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*AwardReqGetNewUser) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func (*AwardAckGetNewUser) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{5} }

...
type NiuniuSrvUser struct {
	...
	// 推注相关
	TuizhuScore        *int32 `protobuf:"varint,26,opt,name=tuizhuScore" json:"tuizhuScore,omitempty"`
	LastTuizhuCircleNo *int32 `protobuf:"varint,27,opt,name=lastTuizhuCircleNo" json:"lastTuizhuCircleNo,omitempty"`
	XXX_unrecognized   []byte `json:"-"`
}
...
func (m *NiuniuSrvUser) GetTuizhuScore() int32 {
...
func (m *NiuniuSrvUser) GetLastTuizhuCircleNo() int32 {
	if m != nil && m.LastTuizhuCircleNo != nil {
		return *m.LastTuizhuCircleNo
	}
	return 0
}
...
var fileDescriptor35 = []byte{
	...
	,
}
